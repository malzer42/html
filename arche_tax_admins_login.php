...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($user && password_verify($password, $user['password'])) {
        ...
        $error = "Administrateur des Impots or Mot de passe invalide";
    }
}
?>
<!DOCTYPE html>
...
<head> <!-- Begin of Head -->
    <meta charset="UTF-8" />
    <title>Administrateur Impots Login </title>
...
<body>
  ...
  <h3>Administrateur Impots de l'Arche de Dieu </h3><br><br>
